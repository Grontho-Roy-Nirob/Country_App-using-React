...
const Signup = () => {
  ...
  const renderPasswwordError = formik.touched.password && formik.errors.password && <span style={{color: 'red'}}>{formik.errors.password}</span>
  ...
  const renderForm =  <form onSubmit={formik.handleSubmit}>
            ...
            <div>
                ...
                <input type="emmail" id="email" name="email" onChange={formik.handleChange} value={formik.values.email} required/>
                <br/>
                {renderEmailError}
            </div>
